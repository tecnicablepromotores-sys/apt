...
fun PerfilUsuario?.checkIsAdmin(): Boolean {
    ...
    val ced = cedula.trim().replace(" ", "").replace("-", "")
    return r.contains("admin") ||
           u.contains("admin") || u.contains("luifred") || u.contains("tecnicablesede") ||
           c.contains("admin") || c.contains("luifred") || c == "tecnicablesedemargarita@gmail.com" ||
           n.contains("admin") || n.contains("luifred") ||
           ced == "26625329" ||
           uuid == "f9286c30-4a28-40e6-9e47-8490c65e03b"
}
